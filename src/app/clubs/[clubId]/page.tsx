...
// We need to wrap the component that uses useToast in a client component,
// or make this page a client component if the toast is triggered by an async function's direct child.
// For simplicity, let's make the main page component client-side if it needs to call toast directly.
// However, the button onClick can call toast. Let's try to keep it server and call toast from client part.

// ClubDetailsContent component to allow using hooks like useToast
function ClubDetailsContent({ club }: { club: Club }) {
